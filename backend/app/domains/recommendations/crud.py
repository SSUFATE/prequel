...
# from app.domains.tag.model import Tag
# from app.domains.kcontent_tag.model import KContentTag
# from app.domains.literature_tag.model import LiteraryWorkTag
...
#             Tag.tag_id,
#             Tag.name,
#             KContentTag.weight.label(
#                 "content_weight"
#             ),
#             LiteraryWorkTag.weight.label(
#                 "work_weight"
#             )
#         )
#         .join(
